...
public class UDPEchoServer {
    ...
    private static void printReceivedMessage(DatagramPacket received) {
    ...
    private static void reply(DatagramPacket received) throws IOException {
        System.out.print("Digite a resposta para o cliente: ");
        String serverResponse = scanner.nextLine();
        byte[] responseMessage = serverResponse.getBytes();
        reply(received, responseMessage, responseMessage.length);
    }
